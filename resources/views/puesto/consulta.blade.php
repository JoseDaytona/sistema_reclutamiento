...
<div class="w-full mt-6 bg-white">
    <div class="flex p-2">
        <a href="{{ route('puesto.create') }}" class="w-40 bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md shadow-sm">Nuevo Registro</a>
    </div>
    <hr>
    <div class="p-4">
        <div id="gvtable"></div>
