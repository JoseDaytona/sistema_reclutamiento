@extends('layout.main')
@section('main')
<h1 class="text-2xl font-bold text-black pb-3">Gestión de Departamentos</h1>
<hr>
<div class="w-full mt-6 bg-white">
    <div class="flex p-2">
        <a href="{{ route('departamento.create') }}" class="w-40 bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded-md shadow-sm">Nuevo Registro</a>
    </div>
    <hr>
    <div class="p-4">
        <div id="gvtable"></div>
        ...
        $("#gvtable").dxDataGrid({
            ...
            columns: [{
                    ...
                    cellTemplate: function(container, cellInfo) {
                        ...
                        var url_e = "{{ route('departamento.edit', 'key_codigo') }}";
                        ...
                        var url_d = '{{ route("departamento.destroy", "key_codigo") }}';
